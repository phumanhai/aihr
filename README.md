...
- AIHR Product Lab cho dao tao va dong hanh build prototype/MVP app HR bang AI.
- 8 app HR mau trong Product Lab, bao gom app danh gia nang luc nhan su.
- CTA Product Lab co visual ngan gon dang luong HR -> AI -> App.
- 3 goi: AIHR Foundation, Build App AIHR Bootcamp, AIHR Advisory Sprint.
...
Section `AIHR Product Lab` duoc thiet ke de nhan manh AIHR la don vi dao tao, tu van nghiep vu va dong hanh xay nang luc noi bo, khong phai don vi ban phan mem nhan su dong goi.

Product Lab hien co 8 app HR mau/case study thuc hanh:

```text
1. App quan ly ho so nhan su
2. App cham cong va nghi phep
3. App quan ly dao tao noi bo
4. App tuyen dung co ban
5. App KPI va danh gia hieu suat
6. App tro ly AI hoi dap chinh sach nhan su
7. App dashboard bao cao nhan su
8. App danh gia nang luc nhan su
```

Luu y: cac app nay la app mau/case study thuc hanh trong chuong trinh dao tao, khong phai phan mem AIHR ban thuong mai.
